"""
Django settings for late_glitter_40904 project.
...
ROOT_URLCONF = 'late_glitter_40904.urls'
...
WSGI_APPLICATION = 'late_glitter_40904.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_glitter_40904 API",
    "DESCRIPTION": "API documentation for late_glitter_40904 App",
    "VERSION": "v1",
}
